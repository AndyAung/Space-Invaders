...
def main():
    ...
    majesty_sound = pygame.mixer.Sound("Majesty.ogg")
    ...
    def texts(score, location_x, location_y, text, color, size):
       font = pygame.font.Font(None,size)
       scoretext = font.render(text + str(score), 1, color)
    ...
    while True:
        ...
        if life == False:
            ...
            texts("", 200, 230, "GAME OVER!", RED, 120)
            game_over.play()
        ...
        if life == True:
            ...
            if again == False:
                lasery -= 10
                pygame.draw.circle(screen, RED, (laserx, lasery), 10)
        ...
        #Winner statment
        if alien_list == []:
            texts("", 300, 230, "YOU WIN", PURPLE, 120)
            majesty_sound.play()
